   ...
   <div class="container-fluid bg-dark text-light" style="height: 100vh; ">
    ...
    <div class="row align-items-center mt-2 ">
      <div class="col-12 text-center">
        @if ($user->image)
          <img src="{{ asset('storage/'.$user->image) }} " alt="" style="border-radius: 20px; border: solid 4px;" width="150" height="150">
        @else
        <img src="../gambar/gambar5.png " alt="" style="border-radius: 20px; border: solid 4px;" width="150" height="150">
        @endif
         
       <h2 class="mt-2">//Fotografer//</h2>
       <h4 style="font-family: times new roman;">Welcome <i>"{{ $user->name }}"</i> to my website Fotografer</h4>
    </div>
    </div>
    </div>
    ...
    <div class="col-md-4 g-5">
      <div class="card mt-4" style=" border-radius: 20px; background-color: bisque;">
        ...
        <div class="card-body">
          ...
          <a href="../setelah_login/kupon" class="btn btn-outline-dark d-block">Klaim Kupon</a>
    ...
    <div class="col-md-4 g-5">
      <div class="card mt-4" style=" border-radius: 20px; background-color: bisque; ">
        ...
        <div class="card-body">
          ...
          <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          <a href="../setelah_login/harga" class="btn btn-outline-dark d-block">Lihat Harga Paket</a>
          <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: larger;">
            50k
            <span class="visually-hidden">unread messages</span>
          </span>
    ...
    <div class="col-md-4 g-5">
      <div class="card mt-4" style="  border-radius: 20px; background-color: bisque;">
        ...
        <div class="card-body">
          ...
          <p class="card-text text-dark ">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          <a href="../setelah_login/tips" class="btn btn-outline-dark d-block">Tips&Trik</a>
      </div> 
      </div>
    </div>
      <!--konten 2 bawah-->
      ...
      <div class="col-md-4 g-5" style="margin-bottom: 50px;">
        <div class="card mt-4" style=" border-radius: 20px; background-color: bisque;">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <a href="../setelah_login/gallery" class="btn btn-outline-dark d-block">Lihat Gallery</a>
              <span class="visually-hidden">unread messages</span>
            </span>
        </div>
        </div>
      ...
      <div class="col-md-4 g-5" style="margin-bottom: 50px;">
        <div class="card mt-4" style="  border-radius: 20px; background-color: bisque;">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-dark ">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <a href="../setelah_login/contact" class="btn btn-outline-dark d-block">Hubungi Kami</a>
        </div> 
        </div>
      </div>
