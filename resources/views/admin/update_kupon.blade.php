    ...
    <div>
     ...
     <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 container-fluid bg-dark text-light" style="width: 100%; padding-bottom: 40px; ">
        <div class="row align-items-center justify-content: center; display:flex;">
          <h2 style="text-align: center; font-family: times new roman; margin-top: 20px; margin-bottom: 30px">--UPDATE KUPON--</h2>
        ...
        <div class="row" style="text-align: center; padding-left: 20px; padding-right: 20px;">
          ...
          <div class="card mt-4 shadow-lg" style="border-radius: 20px;">
            <div class="card-header bg-dark text-light shadow-lg mt-3" style="border-radius: 20px; font-family: times new roman; margin-bottom:10px">
                <h2>FORM UPDATE KUPON</h2>
                
                <form method="POST" action="{{ route('kuponupdate', ['jenis' => $user->jenis]) }}">
                    @csrf
                        @if(session('success'))
                  ...
                  <div class="mb-3 ">
                    <input value="{{ $user->syarat }}"  name="syarat" type="text" class="form-control shadow-lg" id="name" aria-describedby="name" placeholder="Harga Product">
                  </div>
                  <div class="mb-3 ">
                    <input value="{{ $user->waktu }}"  name="waktu" type="date" class="form-control shadow-lg" id="name" aria-describedby="name" placeholder="Batas Waktu">
                  </div>
